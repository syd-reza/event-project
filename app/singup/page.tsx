  ...
  return (
    <div className="container mt-6">
      ...
      <form action="#" className="">
        ...
        >
          <img src="/svg/User-Outline.svg" alt="email-icon" />
          <input
            type="text"
        ...
        <div dir="ltr" className="flex items-center gap-3 mt-4">
          <input type="checkbox" />
          <p className="text-[#3B4453] text-xs">
            I agree to the medidoc{" "}
            <span className="text-[#199A8E]">Terms of Service</span> and{" "}
            <span className="text-[#199A8E]">Privacy Policy</span>
          </p>
        </div>
      ...
      <p className="text-center text-[#717784] text-sm mt-6">
        Do you have an account? <span className="text-[#199A8E]">Login</span>
      </p>
    </div>
  );
}
